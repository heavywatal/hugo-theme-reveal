...
var pe = class {
	constructor(e) {
		S(this, "MAX_REPLACE_STATE_FREQUENCY", 300), this.Reveal = e, this.writeURLTimeout = 0, this.replaceStateTimestamp = 0, this.onWindowHashChange = this.onWindowHashChange.bind(this);
	}
	bind() {
